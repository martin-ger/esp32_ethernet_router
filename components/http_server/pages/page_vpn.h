...
.status-table { background: rgba(16, 32, 16, 0.6); border-radius: 12px; padding: 1rem; margin: 1rem 0; border: 1px solid rgba(0, 230, 118, 0.1); }\
...
document.body.innerHTML ='<div id=\"container\"><h1>WireGuard VPN</h1><p style=\"text-align:center; margin: 2rem 0; color: #00e676;\">Settings saved! Rebooting...</p></div>';\
