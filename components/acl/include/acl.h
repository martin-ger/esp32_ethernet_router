 ...
 *
 * Provides packet filtering capabilities for the ESP32 Ethernet Router.
 *
 * Network topology:
 ...
 * - from_eth: Clients -> ESP32 (incoming on Ethernet interface)
 * - to_eth:   ESP32 -> Clients (outgoing on Ethernet interface)
 */
...
#define ACL_FROM_ETH  2   /* Clients -> ESP32 (Ethernet interface input) */
#define ACL_TO_ETH    3   /* ESP32 -> Clients (Ethernet interface output) */
 ...
 * @param name List name ("from_esp", "to_esp", "from_eth", "to_eth")
